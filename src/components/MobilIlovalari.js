...
const MobilIlovalari = () => {
    return (
        <div>
            <div className="mobilIlovalar">
                <img src="./images/uzb 1.png" className="backImg"/>
                    <div className="d-flex align-items-center justify-content-start mobilLinkkk">
                ...
                {/*<div className="mobilIlovalar1">*/}
                {/*    <div className="container">*/}
                        {/*<div className="row">*/}
                            {/*<div className="col-8">*/}
                            {/*    <p>Ilovani yuklab oling !</p>*/}
                            {/*    <h2>*/}
                            {/*        Dachaonline.uz mobil<br/> ilovasini hoziroq yuklab oling !*/}
                            {/*    </h2>*/}
                            {/*    <span>*/}
